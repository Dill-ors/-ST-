...
extern float a_x,a_y,v_x,v_y,x_x,x_y;
extern float a_x_last,a_y_last,v_x_last,v_y_last;

extern float Angle_z_init,Angle_z;

extern u8 flag_posture_control;
extern float speed_inc, speed_inc_exit;

extern float z_0_PID, z_t_PID, z_t_PID_last, DV_z, DV_z_last, DV_z_last2;
