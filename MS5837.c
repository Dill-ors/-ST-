...
int32_t atmospheric = 0;		// 大气压
double Temperature; 			// 温度
int32_t Pressure;				// 压强 经测试应该在4--22之间
/*
C1  压力灵敏度 SENS|T1
C2  压力补偿  OFF|T1
C3	温度压力灵敏度系数 TCS
...
void depth_init(void)
{
	...
	// 取中间五个数的大小
	qsort(Pressures, 10, sizeof(int), compare);  
	for (i = 2; i < 7; i++) atmospheric += Pressures[i];
	atmospheric = (int)(atmospheric/5);
